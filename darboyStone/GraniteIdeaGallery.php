...
<head>
    ...
    <title>2012-Quilt Show Pictures - Appleton, WI</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">2012 quilt show</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <?php
			...
			/** settings **/
			$images_dir = './2012pictures-med/';
			$thumbs_dir = './2012pictures-smaller/';
			$thumbs_width = 200;
			$images_per_row = 5;
        ...
        <div class="row text-center">
            <div class="col-lg-12">
                <ul class="pagination">
                    ...
                    <li class=>
                        <a href="./2014-Gallery.php">2014 Gallery</a>
                    </li>
                    <li class="active">
                        <a href="#">2012 Gallery</a>
                    </li>
                    <li>
